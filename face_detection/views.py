...
def gen_frames():
    ...
    mixer.init()
    voice_left = mixer.Sound('lookingleft.wav')
    voice_right = mixer.Sound('lookingright.wav')
    voice_down = mixer.Sound('lookingdown.wav')
    eyes_blink= mixer.Sound('eyesclose.wav')
